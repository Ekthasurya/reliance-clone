...
const ProsumerCameras = () => {
    ...
    const fetchProducts = async () => {
        const category ="Prosumer Cameras"; // Hardcoded category
        try {
                        ...
                        <div className="product-list">
                            {error ? (
                                ...
                                products.map((product) => (
                                    <a href={`#/ProsumerCameras/${product._id}`}  key={product._id}>
...
export default ProsumerCameras;
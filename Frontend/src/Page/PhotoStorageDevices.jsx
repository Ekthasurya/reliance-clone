...
const PhotoStorageDevices = () => {
    ...
    const fetchProducts = async () => {
        const category ="Photo Storage Devices"; // Hardcoded category
        try {
                        ...
                        <div className="product-list">
                            {error ? (
                                ...
                                products.map((product) => (
                                    <a href={`#/PhotoStorageDevices/${product._id}`}  key={product._id}>
...
export default PhotoStorageDevices;